...
export interface ApiCommandeCommande extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Statut: Schema.Attribute.Enumeration<
      ['En cours ', 'En Livraison ', 'Livr\u00E9e', 'Annul\u00E9e']
    >;
...
export interface ApiFeaturedProductFeaturedProduct
  ...
  attributes: {
    Categorie: Schema.Attribute.Enumeration<
      ['Bracelet', 'Organic', 'Textile', 'Cuivre']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    referralRewards: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    referralsMade: Schema.Attribute.Relation<
      'oneToMany',
      'api::referral.referral'
    >;
    referralsReceived: Schema.Attribute.Relation<
      'oneToMany',
      'api::referral.referral'
    >;
